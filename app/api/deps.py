...
#     result = await session.execute(select(Chef).where(Chef.user_id == token_data.sub))
#     chef = result.scalars().first()

#     if not chef:
#         raise HTTPException(status_code=404, detail="This is not a chef !")
#     return chef
